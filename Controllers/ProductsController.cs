...
namespace ECommerce.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult CreateProduct([FromBody] CreateProductDto createProductDto)
        {
            ...
            {
                ModelState.AddModelError("CustomError", "El producto ya existe ya existe");
                return BadRequest(ModelState);
            }
        ...
        public IActionResult GetProductsForCategory(int categoryId)
        {
            ...
            if (products.Count == 0)
            {
                return NotFound($"No existen productos con el id {categoryId} de categoria");
            }
        ...
        public IActionResult SearchProducts(string searchTerm)
        {
            ...
            if (products.Count == 0)
            {
                return NotFound($"No existe el producto con el nombre o categoria {searchTerm}");
            }
            var productDto = _mapper.Map<List<ProductDto>>(products);
            return Ok(productDto);
        }
        ...
        public IActionResult BuyProduct(string name, int quantity)
        {
            ...
            {
                return BadRequest("El nombre o la cantidad no son validas");
            }
